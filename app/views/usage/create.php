<h3>Tambah Penanggung Jawab Kendaraan</h3>
...
<form method="post" action="/usage/store" class="row g-3">
    ...
    <div class="col-md-4">
        ...
        <input name="pemakai" class="form-control" required>
    </div>

    <div class="col-md-4">
        <label class="form-label">Jabatan</label>
        <input name="jabatan" class="form-control" placeholder="misal: Kabid/Staff">
    </div>
