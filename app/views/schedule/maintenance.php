...
<form method="post" action="/schedule/maintenance/store" class="row g-3 mb-4">
  ...
  <div class="col-md-3"><label class="form-label">Deskripsi</label><input name="description" class="form-control" placeholder="Servis Berkala"></div>
...
<table class="table table-hover">
  <thead><tr><th>Kendaraan</th><th>Deskripsi</th><th>Tanggal Berikutnya</th></tr></thead>
  <tbody>
  <?php foreach($list as $r): ?>
    <tr><td><?= $r['plat'] ?> - <?= $r['merk'] ?></td><td><?= $r['description'] ?></td><td><?= $r['next_date'] ?></td></tr>
  <?php endforeach; ?>
  </tbody>
</table>
