...
<form class="row g-2 mb-3">
  <div class="col-md-2"><select name="jenis" class="form-select"><option value="">Semua Jenis</option><option value="roda2" <?= ($filters['jenis']??'')==='roda2'?'selected':'' ?>>Roda 2</option><option value="roda4" <?= ($filters['jenis']??'')==='roda4'?'selected':'' ?>>Roda 4</option></select></div>
  <div class="col-md-3"><select name="status_kendaraan" class="form-select"><option value="">Semua Status</option><option value="aktif">Aktif</option><option value="non-aktif">Non-aktif</option><option value="rusak">Rusak</option><option value="perbaikan">Sedang diperbaiki</option></select></div>
  <div class="col-md-3"><select name="status_pajak" class="form-select"><option value="">Status Pajak</option><option value="sudah">Sudah bayar</option><option value="belum">Belum bayar</option></select></div>
...
<table class="table table-striped table-hover align-middle">
  <thead><tr><th>Foto</th><th>Plat</th><th>Merk</th><th>Tipe</th><th>Tahun</th><th>Jenis</th><th>Penggunaan</th><th>Status</th><th>Penanggung Jawab</th><th>Aksi</th></tr></thead>
  <tbody>
