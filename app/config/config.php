...
// Muat autoload Composer jika tersedia
...
if (class_exists('Dotenv\Dotenv') && file_exists($rootDir . '/.env')) {
    ...
    // Fallback parser jika phpdotenv belum terinstall
...
// Pengaturan Koneksi Database dari .env
define('DB_HOST', env('DB_HOST', '127.0.0.1'));
define('DB_PORT', env('DB_PORT', '3306'));
define('DB_NAME', env('DB_NAME') ?: env('DB_DATABASE', 'web_aset_kendaraan'));
